 ...
 static void Main(string[] args)
{
    ...
    Console.Write($"\n Tiempo transcurrido: {mlseg} \n");
    Console.Read();
} // 21,4955 milisegundos
```

Con 100_000_000 (cien millones de ejecuciones):

Situación inicial => 2288,3569 milisegundos
Secuencial => 5925,8215 milisegundos (casi 6 segundos)
...
La función *lock* nos permite limitar, a un solo hilo, el acceso de un recurso. Entonces, a nuestro código crítico (aquel codigo que debemos proteger), se lo encapsula dentro de la función *lock* y esta lo protege.
